    ...
    public function completePayment(Request $req){
        $validate = $req->validate(
            [
                ...
                'address'=>'required|string|max:255|regex:/^\d+(\s+[a-zA-ZÀ-ỹ0-9\/\-]+)+$/u',
            ...
            [
                ...
                'address.regex'=>'Địa chỉ không được chứa kí tự đặc biệt. Địa chỉ phải bắt đầu bằng số nhà và chỉ chứa chữ cái, số, dấu /, dấu - và khoảng trắng. <br> Ví dụ: "65 Huỳnh Thúc Kháng - Bến nghé - Quận 1".',
